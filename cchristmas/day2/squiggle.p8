...
message={
  layer=3,
  init=function(this)
  if lvl_id==2 then--should be 2
    this.text="the message that spans the#next several screens is#intended for those who have#legitimately completed#this map.#if you got here through#cart editing or other such#means, i implore you#not to spoil yourself.#it'll taint the satisfaction#when you do beat the map.#if you do read the message,#please don't spoil it#for others. thank you."
  elseif lvl_id==3 then
    this.text="this map was my submission#to ruby's holiday mod jam.#the mods were supposed to#be accessible to most#celeste classic players,#but i had started making#this mod before i knew#about that. instead of#binning it and working on#something easier, i#figured i'd just finish it#and submit it anyway.#the worst that could#happen was that it would get#rejected, right?" 
  elseif lvl_id==4 then
    this.text="despite that, i#didn't expect anyone to#actually complete this map.#just like s, the gameplay is#unbalanced and frustrating#at times. this level of#difficulty combined with#the map's length makes it#an incredibly challenging#endeavor to complete, and#not one that i expected#anyone to see through."
  elseif lvl_id==5 then
    this.text="it genuinely warms my#heart that there are#people who are willing to#put all of that aside and#beat the map anyways. they#push through the difficulty#and all the unfair deaths#and see it to the end.#and for that,#i'm truly grateful."
  elseif lvl_id==6 then
    this.text="thank you to#flyingpenguin, snek, taco,#bacon, cominixo, meep,#finn, ruby, and the rest of#the celeste classic server.#you all made this#mod possible."
  elseif lvl_id==7 then
    this.text="and, of course, thank#you so much for playing.#i wish i could express#the depth of my gratitude.#it means the world that#you were willing to come on#this journey with me."
  elseif lvl_id==8 then
    this.text="you are incredible.#you are beautiful.#you are talented.#and you don't have to prove#yourself to anyone."
  elseif lvl_id==9 then
    this.text="please take care#of yourself.#drink some water.#go for a walk.#if you'd like to talk,#i'll be around the#celeste classic server."
  elseif lvl_id==10 then
    this.text="you can do anything.##with love#-nyl"  
...
levels={
  ...
  "2,2,1,1,thank you 6",
  "2,2,1,1,thank you 7",
  "3,2,1,1,tranquility" --final thank you
...
mapdata={
	[800]=""
}
...

__label__
...
__map__

...

