...
version 41
__lua__
-- celestial valley 1.1
-- by taco360 / petthepetra
...
player={
	...
	draw=function(this)
		...
		if this.work_tile then
			...
			if can_till(this.work_tile) then
				s=142
			elseif can_harvest(plant) then
				s=159
			elseif can_plant(this.work_tile) and tile_at(plant)==0 and seeds>0 then
			 s=143
			elseif can_sell(this.work_tile) and berries>0 then
				s=174
			elseif can_buy(this.work_tile) then
				s=0
				print_outline("coming soon!",1472,32+sin(frames/30),7,0)
			elseif can_mill(this.work_tile) and berries>0 then
				s=175
			end
...
snowball={
	...
	update=function(this)
		...
		if this.is_solid(0,0) then
			local _x=this.x\8
			for _y=0,16 do
				local pos=vector(_x,_y)
				if can_plant(pos) and tile_at(pos)~=107 then
					tile_set(pos,tile_at(pos)-16)
					break
				end
			end
			sfx(22)
...
function tick_tile(pos)
	local num=tile_at(pos)
	local bottom_pos=vector(pos.x,pos.y+1)
	local can_grow=can_plant(bottom_pos)
	
	if num==192 and can_grow then
		-- 1 (sprout) -> 2
		tile_set(pos,193)
	elseif num==193 and can_grow then
		-- 2 -> 3 (grown)
		tile_set(pos,194)
	elseif num==75 then
		--berry bush
	...
	if pos.y==0 and num==0 and flr(rnd(100))==0 then
		init_object(meteor,pos.x*8,-32)
	end
end
__gfx__
...
5777755700000000777777777777777777777777777777770000000000000000cccccccc00000000000000000000000077777777777777777777777700000000
...

...
__gff__

__map__
...

...

__sfx__
...

