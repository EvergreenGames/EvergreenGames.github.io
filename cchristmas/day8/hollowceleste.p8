...
sherboss={
  init=function(this)
    this.health,this.cooldown,this.offset,this.attck,this.offset_ideal,this.metal,this.hitbox=bossphase==0 and 2 or 1,0,0,0,0,false,rectangle(0,0,16,8)
  end,
  update=function(this)
      this.attck-=1
    if rnd(240)>239 and this.attck<-30 then
      this.attck=120
      sfx"35"
    end
...
function _draw()
  ...
  if changedkey_tmr>0 then
    ...
    rectfill(6,58+changedkey_tmr/15,121,70+changedkey_tmr/15,keypal1[flr(changedkey_tmr/40)+1])
    rect(6,58+changedkey_tmr/15,121,70+changedkey_tmr/15,keypal2[flr(changedkey_tmr/40)+1])
    ?"dash key set to: "..keys[dash_button].."!",64-(#keys[dash_button]*2+36),62+changedkey_tmr/15,keypal2[flr(changedkey_tmr/40)+1]
    fillp()
  end
  pal(3,131,1)
  pal(15,140,1)
...

