...
--network @TODO relocate this
pid,show_menu=-1,false
...
player={
  ...
  update=function(this)
    ...
    if spikes_at(this.left(),this.top(),this.right(),this.bottom(),this.spd.x,this.spd.y) or
     (this.y>lvl_ph and (levels_exits[lvl_id].bot=="" or levels_exits[lvl_id].bot==nil)) then
      kill_player(this)
    end
    ...
    --exit from all sides
    if levels_exits[lvl_id] then
      local comp = {function(a) return a<-4 end,function(a) return a>lvl_pw-4 end,function(a) return a>lvl_ph end}
      --,|-/
      for a in all(split("x|left/1-right/2,y|top/1-bot/3")) do
        local at = split(a,"|")
        for b in all(split(at[2],"-")) do
          local bt = split(b,"/")
          if comp[bt[2]](this[at[1]]) and levels_exits[lvl_id][bt[1]] and levels[levels_exits[lvl_id][bt[1]]] then
            load_level(levels_exits[lvl_id][bt[1]])
          end 
        end
      end
    end
  ...
  draw=function(this)
    ...
    if this.x~=clamped then
      if (levels_exits[lvl_id].left==nil or levels_exits[lvl_id].left=="") and this.x < clamped or
      (levels_exits[lvl_id].right==nil or levels_exits[lvl_id].right=="") and this.x > clamped then
        this.x=clamped
        this.spd.x=0
      end
    end
    clamped=max(this.y,-1)
    if this.y~=clamped then
      if (levels_exits[lvl_id].top==nil or levels_exits[lvl_id].top=="") and this.y < clamped then
        this.y=clamped
        this.spd.y=0
      end
    end
...
player_spawn={
  layer=2,
  init=function(this)
    this.x = respawn_x or this.x
    this.y = respawn_y or this.y
    sfx"4"
    this.spr=3
    this.target=this.y
...
checkpoint={
  ...
  update=function(this)
    this.active = respawn_x==this.x-5 and respawn_y==this.y
    if not this.active and this.player_here() then
      for i in all(objects) do
        if i.type==checkpoint then i.active = false end
      end
      respawn_x=this.x-5
      respawn_y=this.y
      this.init_smoke()
  ...
  draw=function(this)
    local c = this.active and 14 or 13
    pal(11,c)
    spr(118+frames/5%3,this.x,this.y)
    pal()
  end
...
function init_level_exits()
  for k,i in pairs(levels_exits) do
    local t = {}
    t.top,t.bot,t.left,t.right = unpack(split(i))
    levels_exits[k] = t
  end
end
...
get - local message to get and receive data from db
]]--
...
function process_input()
  ...
  elseif message.type=="get" then
    if data[1]=="level" then
      ...
      if ui.loading and level_list[ui.sel_index[1]] then load_new_world(level_list[ui.sel_index[1]].startLevel) end
...
__gfx__

...

...

...

...
57ccfccc0000000070000000000cc0000000000770cc000700eeeeeeeeeeee0000000000000000000000000000000c00000000000d000d000000000000000000
...

...

...

...

...

__sfx__
