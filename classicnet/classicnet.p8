...
world_portal={
  ...
  init=function(this)
    if levels_objectdata[lvl_id] then
      ...
      if not levels[this.destination] and pid~=0 then
...
counter={
  ...
  draw=function(this)
    spr(73, this.x, this.y, 2, 1)
    if shaking then
      local s = "0-"..(19-stat(83)).."-"..(59-stat(84)).."-"..(59-stat(85))
      rectfill(hcenter(s,0)-2, this.y-32, hcenter(s,0)+#s*4, this.y-24,7)
      ?s,hcenter(s,0),this.y-30,8
      ?"\ai1v5c1"
    elseif this.go then
      local s = "0-0-0-0"
...
function _update()
  ...
  if is_title() then
    ...
    if did_type and not show_menu and unlocked then
      if type_char=="\t" then
        show_menu=true
        ui.sel_index[1]=1
        ui.state="level_list"
...
function _draw()
  ...
  draw_x=round(cam_x)-64 + (shaking and rnd(4)-2 or 0)
  draw_y=round(cam_y)-64 + (shaking and rnd(4)-2 or 0)
  camera(draw_x,draw_y)
...
levels_objectdata={
  "",
  "32-sparky's world/30-100m/32-snek's world"
}

--mapdata string table
--assigned levels will load from here instead of the map
mapdata={
  [2]=""
}
...
function process_input()
  ...
  if message.type=="init" then
    pid = data[1]
    connected = true
    send_msg("get","level,30")
    send_msg("get","level,32")
    send_msg("get","level,33")
  ...
  elseif message.type=="update" then
    ...
    o.x,o.y,o.spr,o.djump,o.flip.x,o.dash_time,o.spd.x,o.spd.y = data[1],data[2],data[3],data[4],data[5]==1,data[6],data[7],data[8]
